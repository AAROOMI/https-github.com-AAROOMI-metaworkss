...
export const LogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <div className="shine-effect rounded-lg inline-block overflow-hidden">
    <svg
      {...props}
      viewBox="0 0 24 24"
      fill="none"
...
export const MapIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-10.5v.115c0 .474-.114.951-.332 1.383L12 11.25M12 11.25c.218-.432.332-.91.332-1.383V9.75m0 1.5L15 15.75m-3-4.5H9m3 4.5l-3-6m3 6l3-6m-9 6h9m2.25 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zM5.25 21V5.25A2.25 2.25 0 017.5 3h9a2.25 2.25 0 012.25 2.25V21" />
  </svg>
);
...
export const LockClosedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 24 24" fill="currentColor" {...props}>
